  (function() {
            ...
            function uploadToServer(recordRTC, callback) {
                ...
                // var vname = document.getElementsByName('videoName');
                // formData.append('vname', vname);
                callback('Uploading ' + fileType + ' recording to server.');
                console.log("dddd:-  ",formData);
                
                console.log(vname);
                makeXMLHttpRequest('action.php?video=video&userId='+userId+'&vname='+vname, formData, function(progress) {
            ...
            window.onbeforeunload = function() {
                recordingDIV.querySelector('button').disabled = true;
                recordingMedia.disabled = true;
                mediaContainerFormat.disabled = true;
                $("#start-pc").attr('disabled', true); 
